from tkinter import *   #importing tkinter here
...
cal = Tk()              #setting layout with the name
...
btnEquals=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),text="=",bg="powder blue",command=btnEqualIsInput).grid(row=4,column=2)
